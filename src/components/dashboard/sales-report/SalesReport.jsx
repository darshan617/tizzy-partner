            ...
            <div className="row g-4">
                            ...
                            <div className="col-auto">
                                <div className={`${styles.tabBtnGroup} rounded-pill`}>
                                    <input
                                        ...
                                        defaultChecked
                                    />
                                    <label className={`${styles.tbgItem} rounded-pill py-1 px-3`} htmlFor="btnradio1">
                                        Weekly
                                    </label>
                                    ...
                                    <input
                                        ...
                                        autoComplete="off"
                                    />
                                    <label className={`${styles.tbgItem} rounded-pill py-1 px-3`} htmlFor="btnradio2">
                                        Monthly
                                    </label>
                                    ...
                                    <input
                                        ...
                                        autoComplete="off"
                                    />
                                    <label className={`${styles.tbgItem} rounded-pill py-1 px-3`} htmlFor="btnradio3">
                                        Yearly
                                    </label>
                                </div>
                            </div>
                ...
                <div className="col-xl d-xl-flex">
                    <div className="row row-cols-xl-2 row-cols-md-4 row-cols-2 g-3 g-sm-4">
                        ...
                        <div className="col">
                            <div className={`${styles.sectionCard} ${styles.btnDisplay} ${styles.addGrad} h-100 p-3`}>
                                <div className="d-flex">
                                    <div className="col">
                                        ...
                                        <div>
                                            <div className={`${styles.statusBadge} ${styles.up}`}>
                                                <ChevronUp className={`${styles.icon} me-0`} />
                                                <span>8.72%</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className={`${styles.invoiceIcon} ${styles.infoColor} text-end`}>
                            ...
                            <div className={`${styles.sectionCard} ${styles.btnDisplay} ${styles.addGrad} h-100 p-3`}>
                                <div className="d-flex">
                                    <div className="col">
                                        ...
                                        <div className={styles.statValue}>₹ 517.68k</div>
                                        <div>
                                            <div className={`${styles.statusBadge} ${styles.down}`}>
                                                <ChevronUp className={`${styles.icon} me-0`} />
                                                <span>8.72%</span>
                                            </div>
                                        </div>
                                ...
                                <div className={`${styles.invoiceIcon} ${styles.dangerColor} text-end`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className={styles.icon}>
                                        <path fill="currentColor" fillRule="evenodd" d="M10 22h4c3.771 0 5.657 0 6.828-1.172S22 17.771 22 14v-.437c0-.873 0-1.529-.043-2.063h-4.052c-1.097 0-2.067 0-2.848-.105c-.847-.114-1.694-.375-2.385-1.066c-.692-.692-.953-1.539-1.067-2.386c-.105-.781-.105-1.75-.105-2.848l.01-2.834q0-.124.02-.244C11.121 2 10.636 2 10.03 2C6.239 2 4.343 2 3.172 3.172C2 4.343 2 6.229 2 10v4c0 3.771 0 5.657 1.172 6.828S6.229 22 10 22" clipRule="evenodd" opacity="0.5" />
                        ...
                        <div className="col">
                            <div className={`${styles.sectionCard} ${styles.btnDisplay} ${styles.addGrad} h-100 p-3`}>
                                    ...
                                    <div className="col">
                                        ...
                                        <div>
                                            <div className={styles.statusBadge}>
                                                <Minus className={`${styles.icon} me-0`} />
                                                <span>0%</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className={`${styles.invoiceIcon} ${styles.warningColor} text-end`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className={styles.icon}>
                        ...
                        <div className="col">
                            <div className={`${styles.sectionCard} ${styles.btnDisplay} ${styles.addGrad} h-100 p-3`}>
                                ...
                                <div className={`${styles.invoiceIcon} ${styles.successColor} text-end`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className={styles.icon}>
                                        <path fill="currentColor" fillRule="evenodd" d="M14 22h-4c-3.771 0-5.657 0-6.828-1.172S2 17.771 2 14v-4c0-3.771 0-5.657 1.172-6.828S6.239 2 10.03 2c.606 0 1.091 0 1.5.017q-.02.12-.02.244l-.01 2.834c0 1.097 0 2.067.105 2.848c.114.847.375 1.694 1.067 2.386c.69.69 1.538.952 2.385 1.066c.781.105 1.751.105 2.848.105h4.052c.043.534.043 1.19.043 2.063V14c0 3.771 0 5.657-1.172 6.828S17.771 22 14 22" clipRule="evenodd" opacity="0.5" />
