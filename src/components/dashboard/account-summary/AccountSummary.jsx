    ...
    <div className="row align-items-center">
      <div className="col">
        <nav className="breadcrumb mb-0">
          <a className="breadcrumb-item">Welcome,</a>
          <h1 className="breadcrumb-item active" aria-current="page">{name}</h1>
        </nav>
      </div>
    </div>
  </div>
...
const StatBadge = ({ badgeClass, change }) => (
  <div className={`statusBadge ${badgeClass}`}>
...
const StatCard = ({ gradClass, colorClass, Icon, href, label, prefix, count, suffix, badgeClass, change, anchor }) => (
  <div className="col pt-4">
    <div className={`statBox ${gradClass}`}>
      <div className={`statIcon ${colorClass}`}>
        <Icon />
      </div>

      <a href={href} className="statText mt-3">
        <div className="statLabel mb-2">{label}</div>
...
const AccountSummarySection = () => (
  <div className="col">
    <div className="sectionCard py-4 px-sm-4 px-3">
      <div className="mb-2">
        <h2 className="sectionCardHead">Account Summary</h2>
...
const AccountSummary = () => {
  ...
  return (
    <div className="containerMain mx-auto d-flex flex-column">
