...
export default function TransactionSection() {
  ...
  const visibleRenewals = showAllRenewals ? renewals : renewals.slice(0, 5);
                ...
                <div className={`${styles.contentRow} btnDisplay`} key={index}>
                  <div className="row align-items-center">
                    ...
                    <div className="col-8 col-sm">
                      ...
                      >
                        <div
                          className={`avatarSmall flex-shrink-0 ${item.avatarBg}`}
                        >
                          {item.avatar}
                        </div>
                  ...
                  <div className="row align-items-center">
                    <div className="col-md col-7 d-flex flex-wrap">
                      <div className="col-md col-12">
                        ...
                        <div className={`${styles.crDescription} ms-4 ps-2`}>
                          {item.owner}
                        </div>
                      </div>
                    ...
                    <div className="col-sm-4 col-5 d-flex flex-wrap align-items-center gap-3 gap-md-0">
                      <div className="col-md-6 col-12 text-center">
                        ...
                        <small className="d-block dangerColor">
                          {item.wartext}
                        </small>
                      </div>
                      <div className="col-md-6 col-12 text-center">
        ...
        <div className="d-flex justify-content-center">
          {activeTab === "transactions" && transactions.length > 5 && (
            <div className="col-md-2 col-sm-4 col-6">
              ...
              >
                <ChevronsDown
                  className={`icon me-0 ${showAllTransactions ? "rotate-180" : ""}`}
                />
          ...
          {activeTab === "renewals" && renewals.length > 5 && (
            <div className="col-md-2 col-sm-4 col-6">
              ...
              >
                <ChevronsDown
                  className={`icon me-0 ${showAllRenewals ? "rotate-180" : ""}`}
                />
